...
import bgImage from "../../../assets/certificates/certificate_template7.png";
...
const CertificateTemplate7HTML = ({
  studentName,
  courseTitle,
  date,
  instructorName,
...
export default CertificateTemplate7HTML;
