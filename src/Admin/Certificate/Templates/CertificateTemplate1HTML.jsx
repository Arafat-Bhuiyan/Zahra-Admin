...
import bgImage from "../../../assets/certificates/certificate_template2.jpg";
...
const CertificateTemplate1HTML = ({
  studentName,
  courseTitle,
  date,
  instructorName,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          has successfully completed and demonstrated excellence in the course{" "}
          <strong>{courseTitle || "Course Title"}</strong> with exceptional
...
export default CertificateTemplate1HTML;
