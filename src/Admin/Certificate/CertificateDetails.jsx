      ...
      <div className="w-full bg-white rounded-2xl shadow-sm border border-neutral-200 p-6 flex flex-col gap-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4 flex-1 justify-end">
            ...
            <button className="p-2 rounded-[10px] border border-neutral-300 hover:bg-neutral-50 text-neutral-500">
              <Filter size={18} />
            </button>
            <button
              onClick={handleDeselectAll}
              className="px-4 py-2 rounded-[10px] border border-neutral-300 text-slate-400 text-sm font-normal hover:bg-neutral-50 hover:text-slate-600 transition-colors"
            >
              Deselect All
            </button>
          </div>
