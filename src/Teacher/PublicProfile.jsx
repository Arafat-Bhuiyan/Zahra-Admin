...
export default function PublicProfile({ onEditClick }) {
  const profileData = {
...
Dr. Rahman has dedicated her career to making mental health support accessible to the Muslim community, emphasizing the integration of faith and conventional psychological care. She brings together cutting-edge therapeutic techniques with a deep understanding of Islamic worldview and practices.`,
    education: [
      { degree: 'PhD in Clinical Psychology', university: 'University of Cambridge' },
    ...
    specialties: ['Clinical Psychology', 'Islamic Studies', 'Mental Health Counseling', 'Trauma Support'],
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <div className="flex gap-4 mt-3">
                  <a href={`mailto:${profileData.email}`} className="text-sm text-teal-600 hover:underline">
                    {profileData.email}
                  </a>
         ...
         <Link to={'/teacher/edit-profile'}>   <button
             
              className="px-6 py-2 bg-teal-700 text-white rounded-lg hover:bg-teal-800 transition-all font-medium"
            >
              Edit Profile
            </button></Link>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <section className="bg-white rounded-lg p-6 mb-6 border border-gray-200">
          ...
          <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">{profileData.about}</p>
        </section>
        ...
        {/* Specialties Section */}
        <section className="bg-white rounded-lg p-6 mb-6 border border-gray-200">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Specialties & Tags</h2>
        ...
        <section className="bg-white rounded-lg p-6 border border-gray-200">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Achievements & Credentials</h2>
